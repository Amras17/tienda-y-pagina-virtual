...
CREATE TABLE "LoteInsumo" (
    ...
    "proveedorId" INTEGER,
    CONSTRAINT "LoteInsumo_insumoId_fkey" FOREIGN KEY ("insumoId") REFERENCES "Insumo" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "OrdenCompraItem" (
    ...
    "cantidad" REAL NOT NULL,
    "costoUnitario" REAL NOT NULL,
    CONSTRAINT "OrdenCompraItem_ordenCompraId_fkey" FOREIGN KEY ("ordenCompraId") REFERENCES "OrdenCompra" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
-- CreateIndex
CREATE INDEX "LoteInsumo_insumoId_fechaIngreso_idx" ON "LoteInsumo"("insumoId", "fechaIngreso");

-- CreateIndex
CREATE INDEX "MovimientoStock_insumoId_fecha_idx" ON "MovimientoStock"("insumoId", "fecha");
...
-- CreateIndex
CREATE INDEX "VentaItem_preparado_idx" ON "VentaItem"("preparado");
